...
const Realtorsidebar = () => {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-[#45454580]  border-b border-gray-800">
      ...
      {/* Mobile Sidebar */}
      <div
        className={`lg:hidden fixed top-0 left-0 right-0 bg-[#45454580] border-b border-gray-800 z-50 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? "translate-y-0" : "-translate-y-full"
          }`}
      >
        {/* Logo */}
      ...
      <div
        className="hidden lg:flex flex-col w-64 h-screen fixed top-0 left-0 lg:flex-shrink-0 
                   bg-[#4545456e] border-r border-gray-800 z-30"
      >
        {/* Logo */}
